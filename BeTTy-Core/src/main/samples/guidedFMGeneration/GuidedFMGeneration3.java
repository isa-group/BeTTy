...
import main.samples.guidedFMGeneration.fitness.ExplanationsFitness;
...
/* This example shows how to generate a FM with several size constraints and a minimum 
 * branching factor.
 * 
...
public class GuidedFMGeneration3 {
	...
	public static void main(String[] args) throws BettyException, Exception {
		...
		// STEP 2: Create a fitness function determining the optimization criteria (e.g. number of explanations for erros)
		ExplanationsFitness fitnessFunction = new ExplanationsFitness();

		// STEP 3: Search for a feature model with the given size constraints minimizing the branching factor ratio.
		...
		generator.setMaximize(true);									// Set minimization (maximization by default)
