...
public class GuidedFMGeneration1 {
	...
	public static void main(String[] args) throws BettyException, Exception {
		...
		// STEP 2: Create a fitness function determining the optimization criteria (e.g. minimize branching factor)
		BranchFitness fitnessFunction = new BranchFitness();
		...
		generator.setMaximize(false);									// Set minimization (maximization by default)
